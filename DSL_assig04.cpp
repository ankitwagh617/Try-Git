...
public:
    ...
    void insert_without_replacement()
    {
        ...
        while (var == 1)
        {
            ...
            else
            {
                ...
                while (1)
                {
                    if(ht[i -1].telephoneNo == h.telephoneNo)
                    {
    		...
    		else
    		{
    			while(1){
    			    ...
    			    else
    			    {
    			    	...
    			    	if(ht[hash_index].telephoneNo == 0)
    			    	{
    			    		ht[hash_index].telephoneNo = x;
    			    		ht[hash_index].name = s;
    			    		cout<<"Telephone number inserted successfully " << hash_index - 1<< " index of hash table"<< "\n";
    			    		break;
    			    	}
    			    }
    			}
    ...
    void display()
    {
        cout << "TELEPHONE NO."<< "       "<< "NAME"<< "\n";
        for (int i = 0; i < size; i++)
        {
            cout << ht[i].telephoneNo << "         " << ht[i].name << "\n";
        }
    }
    void delete_key()
    {
